/*Judy Liu
  ...
  n=8   .198s    over 5 executions //why are these numbers lower than n=7
  ======================================*/
...
class TourFinder 
{
	...
	if ( solved ){
	    //System.out.println(this); //faster way to solve problem
	    System.exit(0);
	    
	}

	//primary base case: tour completed
	//moves greater than n^2 because it stops when moves surpasses number of total tiles
	...
	//and recursively generate tour possibilities from current pos
	    ...
	    System.out.println( this ); //refresh screen // takes too long
	}
    }//end findTour()
